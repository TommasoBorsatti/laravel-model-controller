...
@if ($errors->any())
	...
	<form action="{{route('movies.update', ['movie' => $movie->id])}}" method="POST">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="cover" name="cover" placeholder="URL Immagine" value="{{old('cover') ? old('cover') : $movie->cover}}">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="director" name="director" placeholder="Regista" value="{{old('director') ? old('director') : $movie->director}}">
		</div>
		<div class="form-group">
